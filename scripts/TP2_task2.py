...
class ControlNode():
    ...
    def __init__(self, params, freq=10):
        ...
        self.state = GVD._STATE_OBSTACLE_TOO_CLOSE
    ...
    def main_loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            robot_pose2D = self.robot.get_pose2D()
            ...
            if self.state == GVD._STATE_OBSTACLE_TOO_CLOSE:
                ...
                F,next_state = self.GVD.meetpoint_two_obstacles()
            elif self.state == GVD._STATE_MEETPOINT_THREE_OBSTACLES:
